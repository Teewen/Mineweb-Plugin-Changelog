                                    ...
                                    <form method="post" action="<?= $this->Html->url(["controller" => "Changelog", "action" => "index", "admin" => true]); ?>" style="margin-left: -15px;">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="control-label" id="level">
                                                ...
                                                (
                                                <span class="label label-success">MISE À JOUR SITE</span>
                                                <span class="label label-info">INFORMATION</span>
                                                <span class="label label-warning">MISE À JOUR JEU</span>
                                                <span class="label label-danger">MISE À JOUR DISCORD</span>
                                                )
                                            </label>
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-exclamation-circle"></span></span>
                                                <select class="form-control" id="level" name="level" required>
                                                    <option value="0">MISE À JOUR SITE</option>
                                                    <option value="1">INFORMATION</option>
                                                    <option value="2">MISE À JOUR JEU</option>
                                                    <option value="3">MISE À JOUR DISCORD</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="author" name="author" placeholder="<?= $Lang->get("CL_PLACEHOLDER_AUTHOR"); ?>" value="<?= $user['pseudo']; ?>" minlength="2" maxlength="50" required>
                                            </div>
                                        </div>
